...
const CareerList = () => {
  // Gabungkan semua pengalaman dari semua kategori
  const experiences = EXPERIENCES.flatMap(exp => exp.experiences);
    ...
    <div className="pb-4 lg:px-24">
      <div className="sm:grid-cols-2 md:grid-cols-3 gap-4">
        {experiences.length > 0 ? (
          ...
          <p>No experiences available.</p> // Tampilkan pesan jika tidak ada pengalaman
        )}
      </div>
    </div>
  );
