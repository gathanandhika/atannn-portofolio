...
const PDetailDisplay = () => {
    ...
    return (
        <div data-scroll-section className="lg:pb-4 lg:px-48 bg-zinc-700 pt-12 ">
            {/* Parent flex container */}
            <div data-scroll data-scroll-speed={-4} className="flex flex-wrap justify-center items-start relative z-0">
