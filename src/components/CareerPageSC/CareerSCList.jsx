...
const CareerSCList = () => {
  ...
  const ShortclassExperiences = EXPERIENCES.find(exp => exp.status === "Shortclass")?.experiences || [];

  return (
    <div className="pb-4 lg:px-24">
      <div className="sm:grid-cols-2 md:grid-cols-3 gap-4">
        {ShortclassExperiences.length > 0 ? (
          ShortclassExperiences.map((experience) => (
            <CustomLink 
